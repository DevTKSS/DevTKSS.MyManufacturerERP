namespace DevTKSS.MyManufacturerERP.Web.Endpoints.Authentication;
...
public static class AuthenticationEndpoints
{
    public static RouteGroupBuilder MapAuthenticationEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        connectgroup.MapGet("/userinfo", (Delegate)UserInfo)
