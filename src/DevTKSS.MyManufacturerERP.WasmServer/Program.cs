...
using DevTKSS.MyManufacturerERP.Server.Features.ToDo;
    ...
    if (app.Environment.IsDevelopment())
    {
            ...
            options =>
        {
            options
                ...
                {
                    flow.RedirectUri = "https://www.etsy.com/oauth/connect";
                    flow.ClientId =  builder.Configuration["Authentication:Etsy:ClientID"];
                    flow.Pkce = Pkce.Sha256;
                    flow.SelectedScopes = ["email_r","shops_r"];
                    flow.AuthorizationUrl = "https://openapi.etsy.com/v3/public/oauth/connect";
                    flow.TokenUrl = "https://openapi.etsy.com/v3/public/oauth/token";
                })                
