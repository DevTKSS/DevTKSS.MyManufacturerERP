...
namespace DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory
{
    ...
    public partial class InventoryPutRequestBody : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody_products>? Products { get; set; }
#nullable restore
#else
        public List<global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody_products> Products { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody"/> and sets the default values.
        /// </summary>
        public InventoryPutRequestBody()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "products", n => { Products = n.GetCollectionOfObjectValues<global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody_products>(global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody_products.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::DevTKSS.MyManufacturerERP.Clients.Etsy.V3.Application.Listings.Item.Inventory.InventoryPutRequestBody_products>("products", Products);
