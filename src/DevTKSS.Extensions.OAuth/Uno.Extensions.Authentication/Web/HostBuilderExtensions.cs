		...
		hostBuilder
			.UseConfiguration(configure: configBuilder =>
					configBuilder
						...
						.Section<TokenCacheOptions>(string.Join(':', name, TokenCacheOptions.DefaultSectionName)) // TODO: Check if this is required as the WebConfiguration already contains a TokenCacheOptions property
				);
